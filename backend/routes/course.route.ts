...
import { addQestion, addReview, deleteCourse, editCourse, getAllCourses, getAllCoursesAdmin, getCourseByUser, getSingleCourse, replyToQuestion, replyToReview, uploadCourse } from '../controllers/course.controller';
